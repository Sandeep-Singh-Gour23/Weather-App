    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
           ...
           const lat = position.coords.latitude;
            ...
            const api1 = ` https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=f07a8c27e854fb18f6d03ab0f4d26add`
            ...
            function result(weather1) {
                ...
                weather_el.innerText = weather1.weather[0].description;
...
const api = {
    key: "f07a8c27e854fb18f6d03ab0f4d26add",
